...
from avant.worker.utils import dump_job_config, dump_package_config
from avant.worker.celery_task import CeleryTask
from avant.worker.checker.abstract import Checker
from avant.worker.mixin import (
    Config,
    PackitAPIProtocol,
)
...
class AvantTaskName(str, enum.Enum):
    ...
    submit_package = "task.run_submit_package_handler"
