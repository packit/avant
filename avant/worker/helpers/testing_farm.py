...
from avant.worker.utils import get_package_nvrs
from avant.worker.celery_task import CeleryTask
from avant.worker.helpers.build import CoprBuildJobHelper
from avant.worker.helpers.testing_farm_client import TestingFarmClient
...
class TestingFarmJobHelper(CoprBuildJobHelper):
    ...
    def is_comment_event(self) -> bool:
        return self.metadata.event_type in (forgejo.pr.Comment.event_type(),)
        ...
        payload = {
            ...
            "notification": {
                "webhook": {
                    ...
                    # in avant/service/api/testing_farm.py
                    # for more details.
