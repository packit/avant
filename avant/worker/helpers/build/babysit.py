...
from avant.events import copr as copr_events
from avant.events import (
    testing_farm,
)
from avant.events.enums import FedmsgTopic
...
from avant.worker.handlers.copr import AbstractCoprBuildReportHandler
from avant.worker.jobs import PackageJobs
from avant.worker.parser import Parser
...
def update_testing_farm_run(event: testing_farm.Result, run: TFTTestRunTargetModel):
    ...
    job_configs = PackageJobs(event).get_config_for_handler_kls(
