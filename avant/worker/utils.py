...
# Create result directory and copy files-avant
mkdir -p "$resultdir"
cp "$specfile" "$resultdir/"

# Copy patch files-avant
echo "Copying patch files-avant..."
...
# Copy source files-avant
echo "Copying source files-avant..."
