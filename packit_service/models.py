...
def get_submitted_time_from_model(
    model: Union["CoprBuildTargetModel"],
) -> datetime:
...
) -> Union[list["CoprBuildTargetModel"]]:
    """
...
def filter_most_recent_target_models_by_status(
    ...
    statuses_to_filter_with: list[str],
) -> Union[set["CoprBuildTargetModel"]]:
    logger.info(
...
class ProjectAndEventsConnector:
    ...
    def get_project(self) -> Optional[Union["GitProjectModel"]]:
...
def get_onboarded_projects() -> tuple[dict[int, str], dict[int, str]]:
    ...
    # TODO : reimplement this section for avant
